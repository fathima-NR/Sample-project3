      ...
      <div className="container mt-5">
        <div className="row g-3 mt-5">
          ...
          >
            ...
            >
              <h5 className='fw-bold pb-3'>On Time Delivery</h5>
              <p>We work hard to ensure timely delivery of services.</p>
              <p>We always strive to exceed expectations.</p>
            </motion.div>
          </motion.div>
          <motion.div
            className="col-sm-3 d-flex align-items-stretch"
          ...
          >
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <h5 className='fw-bold pb-3'>Cutting Edge Technology</h5>
              <p>We utilize the latest technologies in the engineering industry to provide you with the best possible solutions.</p>
            </motion.div>
          </motion.div>
        </div>
      </div>
