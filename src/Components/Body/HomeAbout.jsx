...
import aboutimg1 from "/src/assets/about-two-image1.jpg"
function HomeAbout() {
    ...
    <div>
      <div className="row d-flex justify-content-center mx-5">
        ...
        >
          ...
          <h3 className='mb-5 fs-2 fw-bold'>Innovative Solution</h3>
          <p className='text-start mb-5 '>{`Technology is more than our job; it’s our passion. We believe every business deserves top-notch IT solutions, and we’re dedicated to making that happen. We combine the latest technology with practical solutions to help you succeed.`}</p>
